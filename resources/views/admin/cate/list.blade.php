                ...
                <table id="datatable-fixed-header" class="table table-striped table-bordered">
                    ...
                    @foreach($cates as $cate)
                        <tr>
                            ...
                            <td>{{$cate->alias}}</td>
                            <td>
                                <a href="{{route(($cate->cateType=='BDS')?'categoryBDS.edit':'category.edit',$cate->id)}}"><button type="button" class="btn btn-icon waves-effect waves-light btn-warning">  <i class="fa fa-wrench"></i> </button></a>
