        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-20">
                            {!! Form::open(['route' => ['category.update',$catePaId->id],'method'=>'put','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']) !!}
                            <div class="form-group">
                                {!! Form::label('title','Title',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                                    {!! Form::text('txtName',old('txtName',isset($catePaId->name)?$catePaId->name:null),['placeholder'=>'To type here','class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('Meta Title','Meta Title',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                                    {!! Form::text('txtMeta','',['placeholder'=>isset($catePaId->metaName)?$catePaId->metaName:null,'class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('Meta Description','Meta Description',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                                    {!! Form::textarea('txtDescription','',['placeholder'=> isset($catePaId->description)?$catePaId->description:null,'class'=>'form-control','rows'=>5]) !!}
                                </div>
                            </div>
                            <div class="form-group">
