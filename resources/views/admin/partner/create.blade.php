        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-20">
                            {!! Form::open(['route' => 'partner.store','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']) !!}
                            <div class="form-group">
                                {!! Form::label('title','Tên*',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                                    {!! Form::text('txtName',old('txtName'),['placeholder'=>'Nhập tên Partner','class'=>'form-control']) !!}
                                </div>
                            </div>
{{--                            <div class="form-group">
...
{{--                            <div class="form-group">
                            ...
                            <div class="form-group">
                                {!! Form::label('hinh-slider',' Image (1170x450)',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
