    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    {!! Form::open(['route' => ['fengshui.update',$getPosts->id],'class'=>'form-horizontal','method'=>'put','role'=>'form','enctype'=>'multipart/form-data']) !!}
                    <div class="col-md-8">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" name="slMenu">
                                        ...
                                        {{getMenu($getDataMenu,0,"",$getPosts->Cate_id)}}
                                    </select>
                            ...
                            <div class="form-group">
                                {!! Form::label('Thumbnail','Thumbnail (500 x 500)',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
