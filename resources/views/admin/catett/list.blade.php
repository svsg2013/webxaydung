                ...
                <table id="datatable-fixed-header" class="table table-striped table-bordered">
                    ...
                    @foreach($cates as $cate)
                        <tr>
                            <td>{{$cate->name}}</td>
                            <td>
                                <a href="{{route('catefengshui.edit',$cate->cateParen_id)}}"><button type="button" class="btn btn-icon waves-effect waves-light btn-warning">  <i class="fa fa-wrench"></i> </button></a>
