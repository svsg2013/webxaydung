        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-20">
                            {!! Form::open(['route' => ['slider.update',$list->id],'method'=>'put','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']) !!}
                            <div class="form-group">
                                {!! Form::label('title','Tên Slider*',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                                    {!! Form::text('txtName',old('txtName',isset($list->name)?$list->name:null),['placeholder'=>'Nhập tên SLider','class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                {!! Form::label('hinh-slider','Hình Slider hiện tại',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                                    <img src="{{asset('uploads/sliders/'.$list->images)}}" style="width: 300px" />
                                </div>
                            </div>
                            <div class="form-group">
