...
use App\Repositories\Fur\FurnitureRepositoryInterface;
...
class FurnitureController extends Controller
{
    ...
    public function __construct(FurnitureRepositoryInterface $newsrepositoryinterface)
    {
    ...
    public function index()
    {
        ...
        return view('admin.furs.list')->with(['getData'=>$getAll]);
    }
    ...
    public function create()
    {
        ...
        return view('admin.furs.create')->with(['getDataMenu'=>$getMenu,'getTags'=>$getTag,'getPosts'=>$getPost]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.furs.edit')->with(['getDataMenu'=>$getMenu,'getTags'=>$getTag,'getPosts'=>$getPost,'unseris'=>$unseri]);
    }
